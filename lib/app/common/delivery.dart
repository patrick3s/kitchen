...
class DeliveryCart extends StatelessWidget {
  ...
  final Size size;
   DeliveryCart({ Key key,this.cartModel,this.size }) : super(key: key);
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border(
            bottom: BorderSide(color: activate ? Colors.brown :Colors.transparent )
          )
        ),
        child: Text(title,
        style: TextStyle(
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          Center(
            child: Icon( status ? IconsPlatform.editLocation : IconsPlatform.person,
            size: size.width * .07,
            ),
          )
        ],
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text("${userModel.address['street']},${userModel.address['numberHome']} - ${userModel.address['complement']}",
          style: style.copyWith(
            fontSize: size.width * .035,
            fontWeight: FontWeight.bold
          ),
          ),
          Text("${userModel.address['city']} - ${userModel.address['uf']}",
          style: style,
          )
        ],
      ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text("${partner.street},${partner.numberHome} - ${partner.complement}",
          style: style.copyWith(
            fontSize: size.width * .035,
            fontWeight: FontWeight.bold
          ),
